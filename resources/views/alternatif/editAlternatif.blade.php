...
@section('content')
    <div class="flex flex-col items-center pb-10">
        <h5 class="mb-1 text-xl font-medium text-black dark:text-white py-3">Edit Data Alternatif</h5>
        <div
            ...
            <div class="input-body">
                ...
                @endif
                <form method="post" action="{{ route('data-alternatif.update', $alternatif->id) }}" id="myForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group py-2">
                        <label for="nama_alternatif" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Alternatif</label>
                        <input type="text" name="nama_alternatif" value="{{$alternatif->nama_alternatif}}" id="nama_alternatif" aria-describedby="nama_alternatif"
