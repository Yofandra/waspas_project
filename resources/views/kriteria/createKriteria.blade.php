            ...
            <div class="input-body">
                ...
                <form method="post" action="{{ route('data-kriteria.store') }}" id="myForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group py-2">
                        ...
                        <input type="text" name="nama_kriteria" id="nama_kriteria" aria-describedby="nama_kriteria"
                    ...
                    <div class="form-group py-2">
                        ...
                        <input type="text" name="bobot_kriteria" id="bobot_kriteria" aria-describedby="bobot_kriteria"
                            class="formcontrol bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-logo focus:border-green-logo block w-full p-2.5 dark:bg-white dark:border-gray-600">
                    </div>
                    <div class="form-group py-2">
